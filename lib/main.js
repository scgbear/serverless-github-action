...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const authType = authenticationType_1.AuthenticationTypeUtil.FromString(core.getInput('authtype', { required: true }));
            const credentialParser = new CredentialParser_1.CredentialParser(authType, creds);
